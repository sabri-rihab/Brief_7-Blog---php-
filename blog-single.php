...
$category = getCatgByArticleID($pdo, $article['catg_id']);



if(isset($_POST['comment_submit'])){
    $comment_content = $_POST['comment_content'];
    addComment($pdo, $userName, $comment_content, $article_id);
}
?>
<!doctype html>
<html lang="en">
        ...
        <div class="row blog-entries element-animate">
          <div class="col-md-12 col-lg-8 main-content">
            <img src="images/img_10.jpg" alt="Image" class="img-fluid mb-5">
             <div class="post-meta">
                <span class="author mr-2"><img src="images/person_1.jpg" alt="Colorlib" class="mr-2"><?php echo $article['user_id']; ?></span>&bullet;
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="#" method="post" class="p-5 bg-light">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="comment_content" id="message" cols="30" rows="10" class="form-control" placeholder="write your comment here" required></textarea>
                  </div>
                  <div class="form-group">
                    <input type="submit" name="comment_submit" value="Post Comment" class="btn btn-primary">
                  </div>
